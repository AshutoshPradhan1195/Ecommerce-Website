...
extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Boolean isUserRegistered = con.checkPassword("Select user_pass from login_info Where user_email = ?", email, password = request.getParameter("userPass"));
        if (isUserRegistered != null && isUserRegistered.booleanValue()) {
            ...
            request.setAttribute("errorMessage", (Object)"Invalid Username or Password");
